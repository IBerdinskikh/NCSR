...
def adjust_brightness(lr: None, hr: None, p: float = 0.5) -> [Any, Any]:
    ...
    rnd = random.random()
    if rnd >= p:
        lr = F.adjust_brightness(lr, brightness_factor=rnd + 0.25)
        hr = F.adjust_brightness(hr, brightness_factor=rnd + 0.25)
...
def adjust_contrast(lr: None, hr: None, p: float = 0.5) -> [Any, Any]:
    ...
    rnd = random.random()
    if rnd >= p:
        lr = F.adjust_contrast(lr, contrast_factor=rnd + 0.25)
        hr = F.adjust_contrast(hr, contrast_factor=rnd + 0.25)
...
def adjust_saturation(lr: None, hr: None, p: float = 0.5) -> [Any, Any]:
    ...
    rnd = random.random()
    if rnd >= p:
        lr = F.adjust_saturation(lr, saturation_factor=rnd + 0.25)
        hr = F.adjust_saturation(hr, saturation_factor=rnd + 0.25)
